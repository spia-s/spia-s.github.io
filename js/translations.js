...
const translations = {
    ...
    fr: {
        ...
        "hero.description": "Dans un monde de bruit sans fin, Spia se concentre sur l'essentiel — les histoires qui nous font ressentir, réfléchir et grandir. Découvre des livres, des idées et des perspectives choisis avec soin pour émerveiller à chaque étape de la vie.",
        ...
        "platforms.kidscorner-name": "KidsCorner.",
        "platforms.stories": "Des histoires pour les jeunes lecteurs et leurs accompagnateurs,",
        "platforms.glance": "où un simple regard peut renforcer l'empathie,",
        "platforms.perspective": "le regard et l'amour de la lecture.",
        "about.welcome": "Bienvenue dans un espace numérique conçu pour ceux qui croient que les histoires nous façonnent.",
        "about.content": "À l'ère du contenu sans limite, l'intention prime sur le volume. Chaque livre, idée et recommandation ici a été sélectionné avec soin pour stimuler la curiosité, approfondir la compréhension émotionnelle et ouvrir de nouvelles perspectives sur le monde.",
        "about.spia-role": "Spia ne se contente pas d'organiser du contenu. Il relie les sens.",
        "about.built": "Trois idées fondamentales guident cette démarche :",
        "about.feeling": "Ressentir. Des histoires qui nous aident à nous comprendre et à comprendre les autres",
        "about.thinking": "Réfléchir. Des idées qui挑战ent, interrogent et élargissent notre vision des choses",
        "about.growing": "Grandir. Des outils qui accompagnent l'apprentissage tout au long de la vie, de la petite enfance à l'âge adulte",
        "about.kidscorner.desc": "KidsCorner, la première branche de Spia, s'adresse aux jeunes lecteurs et aux adultes qui les accompagnent. Elle mise sur des livres qui renforcent l'intelligence émotionnelle, la conscience culturelle et un véritable amour de la lecture, sans submerger par les choix.",
        "about.expand": "Spia continuera à s'ouvrir à de nouveaux domaines, toujours guidée par le même principe :",
        "about.less-noise": "Moins de bruit. Plus de sens.",
        "footer.tagline": "Quand les histoires montrent la voie.",
        ...
        "footer.affiliate": "Communication affiliation",
